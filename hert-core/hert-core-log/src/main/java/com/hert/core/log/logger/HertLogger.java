package com.hert.core.log.logger;

import com.hert.core.log.publisher.UsualLogPublisher;
 ...
 */
@Slf4j
public class HertLogger implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		log.info(serviceId + ": HertLogger init success!");
	}
