package com.hert.core.secure.aspect;

import com.hert.core.secure.annotation.PreAuth;
import com.hert.core.secure.auth.AuthFun;
...
public class AuthAspect implements ApplicationContextAware {
	 ...
	 */
	@Around(
		"@annotation(com.hert.core.secure.annotation.PreAuth) || " +
			"@within(com.hert.core.secure.annotation.PreAuth)"
	)
