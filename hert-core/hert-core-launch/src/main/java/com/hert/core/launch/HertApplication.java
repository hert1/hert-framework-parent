...
public class HertApplication {
	...
	public static SpringApplicationBuilder createSpringApplicationBuilder(String appName, Class source, String... args) {
		...
		String startJarPath = HertApplication.class.getResource("/").getPath().split("!")[0];
		...
		props.setProperty("hert.env", profile);
		props.setProperty("hert.name", appName);
		props.setProperty("hert.is-local", String.valueOf(isLocalDev()));
		props.setProperty("hert.dev-mode", profile.equals(AppConstant.PROD_CODE) ? "false" : "true");
		props.setProperty("hert.service.version", AppConstant.APPLICATION_VERSION);
