...
public class HertFileUtil {
	 ...
	 * @return HertFile
	 */
	public static HertFile getFile(MultipartFile file) {
	 ...
	 * @return HertFile
	 */
	public static HertFile getFile(MultipartFile file, String dir) {
	 ...
	 * @return HertFile
	 */
	public static HertFile getFile(MultipartFile file, String dir, String path, String virtualPath) {
		return new HertFile(file, dir, path, virtualPath);
	}
	 ...
	 * @return HertFile
	 */
	public static List<HertFile> getFiles(List<MultipartFile> files) {
	 ...
	 * @return HertFile
	 */
	public static List<HertFile> getFiles(List<MultipartFile> files, String dir) {
	 ...
	 * @return HertFile
	 */
	public static List<HertFile> getFiles(List<MultipartFile> files, String dir, String path, String virtualPath) {
		List<HertFile> list = new ArrayList<>();
		for (MultipartFile file : files) {
			list.add(new HertFile(file, dir, path, virtualPath));
		}
		return list;
	}
