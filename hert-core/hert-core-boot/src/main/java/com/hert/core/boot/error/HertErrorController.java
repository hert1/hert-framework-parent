 ...
 * @author Chill
 */
public class HertErrorController extends BasicErrorController {

	public HertErrorController(ErrorAttributes errorAttributes, ErrorProperties errorProperties) {
