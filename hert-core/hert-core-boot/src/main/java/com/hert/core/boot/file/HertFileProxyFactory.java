...
import com.hert.core.tool.utils.ImageUtil;
 ...
 * @author hert
 */
public class HertFileProxyFactory implements IFileProxy {
	...
	public String[] path(File f, String dir) {
		...
		return new String[]{HertFileUtil.formatUrl(uploadPath.toString()), HertFileUtil.formatUrl(virtualPath.toString())};
	}
